...
setwd("C:/Stock_Assessments/VRML_Assessment_2021/GitHub/Vermilion_2021/write_up/SCA")

# Create the needed items to generate the "right" template that would be based on the inputs here:
sa4ss::draft(authors = c("E. J. Dick", "Melissa H. Monk", "Tanya L. Rogers",
...
dir.path <-  "C:/Stock_Assessments/VRML_Assessment_2021/Model_files/SCA/"
