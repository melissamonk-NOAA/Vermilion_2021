...
\hypersetup{
  pdftitle={Status of Vermilion Rockfish (Sebastes miniatus) along the US West Off California north of Pt. Conception coast in 2021},
  pdflang={en},
  hidelinks,
...
\date{}
\newcommand{\trTitle}{Status of Vermilion Rockfish (\emph{Sebastes miniatus}) along the US West Off California north of Pt. Conception coast in 2021}
\newcommand{\trYear}{2021}
\newcommand{\trMonth}{April}
\newcommand{\trAuthsLong}{true}
\newcommand{\trAuthsBack}{Monk, M.H.}
\newcommand{\trCitation}{
...
\noindent
\begin{center}
\title{Status of Vermilion Rockfish (\emph{Sebastes miniatus}) along the US West Off California north of Pt. Conception coast in 2021}
% \textnormal{\MakeTextUppercase{\trTitle{}}}
\vspace{1.5cm}
{\Large\textbf\newline{Status of Vermilion Rockfish (\emph{Sebastes miniatus}) along the US West Off California north of Pt. Conception coast in 2021}}
\vfill
by\\
Melissa H. Monk\textsuperscript{1}\vfill
...
This assessment reports the status of Vermilion Rockfish (\emph{Sebastes miniatus}) off the US West Off California north of Pt. Conception coast using data through xxxx.
