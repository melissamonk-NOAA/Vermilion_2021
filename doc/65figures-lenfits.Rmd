...
for (i in 1:length(unique_fleets)) {
   add_figure(
    ...
    label = paste0("len-pearson-", fleet_info$FleetNames[fleet_info$fleet_ID==unique_fleets[i]])
    #,
    #width = 50,
    #height = 50
  )
   ...
   add_figure(
    ...
    label = paste0('mean-len-fit-', fleet_info$FleetNames[fleet_info$fleet_ID==unique_fleets[i]])
    #,
    #width = 50,
    #height = 50
  )
