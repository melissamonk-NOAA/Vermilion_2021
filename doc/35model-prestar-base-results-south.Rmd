...
The estimated relative fishing intensity, $(1-SPR)/(1-SPR_{50\%})$, has fluctuated around the target level for the past decade, was above the management target in 2019 and below the management target in 2020 (Figure \@ref(fig:1-spr)). 
