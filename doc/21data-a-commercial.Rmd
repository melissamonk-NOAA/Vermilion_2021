...
for the commercial hook-and-line fleet,`r ifelse(model.area=='NCA', noquote("\\ref{fig:len-data-COM-TWL} for the commercial trawl fleet"), "")`and \@ref(fig:len-data-COM-NET) for the commercial net fleet.
