...
\hypertarget{append-indices}{%
\subsection{Indices of Abundance}\label{append-indices}}
...
sa4ss::read\_child(``./indices/vermilion\_MRFSS\_dockside\_writeup\_SCA.md'') sa4ss::read\_child(``./indices/vermilion\_NWFSC\_HL\_writeup\_SCA.md'')\\
sa4ss::read\_child(``./indices/vermilion\_CA\_CPFV\_onboard\_writeup\_SCA.md'') sa4ss::read\_child(``./indices/vermilion\_CRFS\_PR\_dockside\_writeup\_SCA.md'') sa4ss::read\_child(``./indices/vermilion\_CRFS\_PR\_dockside\_writeup\_SCA.md'')
