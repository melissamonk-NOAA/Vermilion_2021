...
distance (J. R. Hyde and Vetter 2009). Lowe et al. (2009) suggested that vermilion rockfish
...
Hyde (J. R. Hyde and Vetter 2009) and Budrick (Budrick 2016) identified species using mtDNA assays and microsatellite loci,
...
the available habitat within California state waters (0-3 nm) is within MPAs (Figure @ref(index9\_standcpueall)).
...
Abrams, J. L. 2014. \emph{{The effect of local fishing pressure on the size and age structure of fishes associated with rocky habitats along California's north coast}}. Master's T. May. Humboldt State University.
