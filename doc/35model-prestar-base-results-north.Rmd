...
The relative fishing intensity, $(1-SPR)/(1-SPR_{50\%})$, was near the management target in 2020, and has fluctuated aroudnn the target level for the past decade (Figure \@ref(fig:1-spr)). 
