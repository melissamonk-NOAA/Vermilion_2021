...
(2008) described sunset rockfish as a distinct species noting depth separation
...
meat created an increased demand for other sources of protein (Alverson, Pruter, and Ronholt 1964; Harry and Morgan 1961; Lenarz 1987). Trawl landings have been restricted in most of southern California for decades (Frey 1971), and trawl gear north of Point Conception has not been a major component of the landings for vermilion, with the highest reported landings in the 1970s. The commercial setnet fishery has never been a large component of the vermilion rockfish landings and has essentially been non-existent for vermilion since 2002 when the state of California prohibited set net gear in 60 fm or less. The largest net landings for vermilion were in the 1980s.
...
The commercial hook-and-line fleet (and mirrored commercial trawl fleet) were fit to time-varying asymptotic selectivity and the size a full selectivity shifts to smaller fish in the more recent time block (50 cm to 34 cm; Figures Figure @ref(fig:sel03\_len\_timevary\_surf\_flt1sex1) and \ref{fig:endyr-selex-COM-HKL}). The most noticeable change in selectivity for the commercial fleet is the implementation of the CCAs and additional regulatory changes. Catches from the commercial net fishery declined prior to the CCAs. The length compositions from the net fishery did not support a dome shaped selectivity and it was fixed to have asymptotic selectivity (Figure \ref{fig:endyr-selex-COM-NET}).
...
\caption{Sex ratios for length comps, whole catchEarly years hook-and-line. Observed sex ratios (points) with 75\% intervals (vertical lines) calculated as a Jeffreys interval based on the adjusted input sample size. The model expectation is shown in the purple line.\label{fig:sexratio-EARLY-HKL}}
\end{figure}
...
\caption{Coefficient of variation of length at age for vermilion rockfish from the NWFSC hook-and-line survey.\label{fig:cv-length-age}}
\end{figure}
...
\caption{Female ending year selectivity for the CDFW reserach (aka green binder).\label{fig:endyr-selex-CDFW-RESEARCH}}
\end{figure}
...
Ally, J. R. Raymond, David S Ono, Robert B Read, and Michael Wallace. 1991. {``{Status of major Southern California marine sport fish species with management recommendations, based on analyses of catch and size composition data collected on board commercial passenger fishing vessels from 1985 through 1987}.''} 90-2. State of California Department of Fish; Game.
...
Berger, Aaron M, Daniel R Goethel, Patrick D Lynch, Quinn II Terrance, Sophie Mormede, Jeremy Mckenzie, and Alistair Dunn. 2017. {``{Space oddity: The mission for spatial integration}.''} \emph{Canadian Journal of Fisheries and Aquatic Sciences} 74: 1698--1716.
...
Cadrin, Steven X. 2020. {``{Defining spatial structure for fishery stock assessment}.''} \emph{Fisheries Research} 221 (October 2019). \url{https://doi.org/10.1016/j.fishres.2019.105397}.
...
Dick, E. J., Sabrina Beyer, Marc Mangel, and Stephen Ralston. 2017. {``{A meta-analysis of fecundity in rockfishes (genus genus\emph{Sebastes})}.''} \emph{Fisheries Research} 187: 73--85. \url{https://doi.org/10.1016/j.fishres.2016.11.009}.
...
\leavevmode\vadjust pre{\hypertarget{ref-Field2007}{}}%
Field, John C., André E. Punt, Richard D. Methot, and Cynthia J. Thomson. 2006. {``{Does MPA mean `Major Problem for Assessments'? Considering the consequences of place-based management systems}.''} \emph{Fish and Fisheries} 7 (4): 284--302. \url{https://doi.org/10.1111/J.1467-2979.2006.00226.X}.
...
Frey, H. W. 1971. \emph{{California's Living Marine Resources and Their Utilization. California Department of Fish and Gamet}}.
...
Lenarz, W. H. 1987. {``{A history of California rockfish fisheries. In Proceedings of the International Rockfish Symposium.}''} In \emph{International Rockfish Symposium}.

\leavevmode\vadjust pre{\hypertarget{ref-Love1990b}{}}%
Love, Milton S, Pamela Morris, Merritt McCrae, and Robson Collins. 1990. {``{Life history aspects of 19 rockfish species (Scorpaenidae:\emph{Sebastes}) from the Southern Califronia Bight}.''} February. NOAA Technical Report NMFS 87.
...
Pearson, Donald E., and Brenda Erwin. 1997. {``{Documentation of California's Commercial Market Sampling Data Entry and Expansion Programs}.''} NOAA-TM-NMFS-SWFSC-24. National Marine Fisheries Service.
...
Punt, André E., Alistair Dunn, Bjarki Þór Elvarsson, John Hampton, Simon D. Hoyle, Mark N. Maunder, Richard D. Methot, and Anders Nielsen. 2020. {``{Essential features of the next-generation integrated fisheries stock assessment package: A perspective}.''} \emph{Fisheries Research} 229 (September). \url{https://doi.org/10.1016/J.FISHRES.2020.105617}.

\leavevmode\vadjust pre{\hypertarget{ref-Punt2004}{}}%
Punt, André E., and Richard D. Methot. 2004. {``{Effects of marine protected areas on the assessment of marine fishes}.''} In \emph{Aquatic Protected Areas as Fisheries Management Tools. American Fisheries Society}, 133--54. Quebec, Canada. \url{https://scholar.google.com/scholar?hl=en\&as_sdt=0\%2C48\&q=+Effects+of+marine+protected+areas+on+the+assessment+of+marine+fisheries.+\&btnG=}.
