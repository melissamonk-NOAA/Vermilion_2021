...
for frog female `r spp` caught by recent fishery-independent surveys. Two types 
...
explained by the fact that while `r spp` have protracted longevity at $L_{\infty}$. 
...
The weight(kg)-length(cm) relationship for `r spp` was estimated external the 
