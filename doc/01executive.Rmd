...
`r round(refpts[1,2], 0)`  million eggs in 2021 (95% asymptotic interval: 
`r paste0(round(refpts[1,3],0), " - ", round(refpts[1,4],0))` million eggs) or 
`r scales::percent(refpts[5,2], accuracy = 1)` 
(95% asymptotic interval: 
`r paste0(scales::percent(refpts[5,3], accuracy = 1)," - ", scales::percent(refpts[5,4], accuracy = 1))` million eggs) 
...
which corresponds with an equilibrium yield of `r round(refpts[10,2],0)` mt 
(95% asymptotic interval: `r paste0(round(refpts[10,3],0), " - ", round(refpts[10,4],0))` mt). 
...
kableExtra::kbl(summaryES,
                booktabs=TRUE,
                caption="Summary of recent estimates and managment quantities for vermilion rockfish.",
                label="summaryES",
                linesep = "",
                escape = FALSE, 
...
kableExtra::kbl(projection,
                booktabs=TRUE,
                caption="Projections of potential OFLs (mt), ABCs (mt), estimated age 4+ biomass (mt), estimated spawning output ($10^6$ eggs) and fraction unfished.",
                label="projectionES",
                linesep = "",
                align = "c",
                 escape = FALSE,
