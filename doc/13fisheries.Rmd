...
North of Point Conception `r spp` in California are most commonly landed from 
...
The contribution of `r spp` to the minor shelf rockfish Over Fishing Limit (OFL) is 
...
to the California-Oregon border (\CAOR).  The southern California `r spp` model contains the 
...
estimates from the NMFS NWFSC are not yet available for 2020 (Table \@ref(tab:managementES)). `r Spp` total 
