...
if(model.area=='NCA'){
  add_figure(
    filein = file.path(paste0(fig_loc,"/jitter_NCA.png")),
    caption = "Results from 50 jittered runs of the pre-STAR base model.  Missing values indicate the run did not converge",
    label = "jitter"
  )
} else {
  add_figure(
    filein = file.path(paste0(fig_loc,"/jitter_SCA.png")),
    caption = "Results from 50 jittered runs of the pre-STAR base model",
    label = "jitter"
  )
}
```
