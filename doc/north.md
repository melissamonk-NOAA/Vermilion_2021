...
A number of sensitivity analyses were conducted prior to the STAR panel, including the following: estimating the steepness parameter $h$, changing the starting year of recruitment deviations from 

Estimating the steepness parameter $h$, 

Changing the starting year of recruitment deviations to 1965 and 1975
...
\caption{(\#tab:drop-one-42)Likelihood components from the leave one out analysis of the pre-STAR base model.}
\centering
\resizebox{\linewidth}{!}{
